export const load = {
  ...
  assets: () => {
    ...
    loadSprite("coin-icon", "./assets/Coin2.png")
    loadSprite("star-icon", "./assets/Stars_Ui2.png")
    loadSprite("coin", "./assets/Coin2.png")
    loadSprite("logo", "./assets/Logo2.png")
    loadSprite("player", "./assets/Player3.png", {
      sliceX: 4,
      sliceY: 6,
      anims: {
        idle: {
    ...
    loadSprite("spider-1", "./assets/Spider_3.png", {
      sliceX: 3,
      sliceY: 1,
      anims: {
    ...
    loadSprite("spider-2", "./assets/Spider_3.png", {
      sliceX: 3,
      sliceY: 1,
      anims: {
        crawl: { from: 0, to: 2, loop: true },
    ...
    loadSprite("fish-1", "./assets/Fish_3.png", {
      sliceX: 2,
      sliceY: 1,
      anims: {
    ...
    loadSprite("flame-1", "./assets/Flame_3.png", {
      sliceX: 2,
      sliceY: 1,
      anims: {
    ...
    loadSprite("flame-2", "./assets/Flame_3.png", {
      sliceX: 2,
      sliceY: 1,
      anims: {
        burn: { from: 0, to: 1, loop: true },
    ...
    loadSprite("bird-1", "./assets/Bird_3.png", {
      sliceX: 3,
      sliceY: 1,
      anims: {
        fly: {
    ...
    loadSprite("bird-2", "./assets/Bird_3.png", {
      sliceX: 3,
      sliceY: 1,
      anims: {
        fly: {
